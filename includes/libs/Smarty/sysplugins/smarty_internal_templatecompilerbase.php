...
// log tag/attributes
        ...
        if (
            in_array("'nocache'", $args) || in_array(array('nocache' => 'true'), $args)
...
// check if tag is a registered object
                if (isset($this->smarty->registered_objects[$tag]) && isset($parameter['object_methode'])) {
                    ...
                    if (
                        !in_array($methode, $this->smarty->registered_objects[$tag][3]) &&
...
// compile this tag
    ...
    public function getPlugin($plugin_name, $type)
    {
        ...
        if ($this->template->caching && ($this->nocache || $this->tag_nocache)) {
            ...
            } elseif (isset($this->template->required_plugins['nocache'][$plugin_name][$type])) {
...
// generate replacement code
            if (
                (!$this->template->resource_object->isEvaluated || $this->template->forceNocache) && $this->template->caching && !$this->suppressNocacheProcessing &&
